...
export const GROUP_STAGE_FIXTURES = [
  ...
  },
  {
    ...
    "home": "Noruega",
    "away": "Senegal",
    "fifaCentreId": "400021491",
    "kickoffUtc": "2026-06-23T05:00:00.000Z",
    "kickoffLabelEs": "mar, 23 jun 2026 · 07:00 (España)"
  },
  {
    "fifa": 42,
    "group": "I",
  ...
  },
  {
    ...
    "home": "Panamá",
    "away": "Croacia",
    "fifaCentreId": "400021511",
    "kickoffUtc": "2026-06-24T04:00:00.000Z",
    "kickoffLabelEs": "mié, 24 jun 2026 · 06:00 (España)"
  },
  {
    "fifa": 47,
    "group": "K",
...
/** @param {string} home @param {string} away */
export function fixtureKey(home, away) {
  return home + '|' + away
}

/** @param {string} home @param {string} away */
export function getFixtureKickoffLabelEs(home, away) {
  const f = GROUP_STAGE_FIXTURES.find(m => m.home === home && m.away === away)
  return f?.kickoffLabelEs ?? null
}

/** @param {string} home @param {string} away */
export function getFixtureByTeams(home, away) {
  return GROUP_STAGE_FIXTURES.find(m => m.home === home && m.away === away) ?? null
}
